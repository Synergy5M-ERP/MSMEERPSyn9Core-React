intellisense.annotate(jQuery, {
  ...
  'map': function() {
    /// <signature>
    ///   <summary>Translate all MASTER_ItemTbl in an array or object to new array of MASTER_ItemTbl.</summary>
...
intellisense.annotate(jQuery.fn, {
  ...
  'clearQueue': function() {
    /// <signature>
    ///   <summary>Remove from the queue all MASTER_ItemTbl that have not yet been run.</summary>
    ///   <param name="queueName" type="String">A string containing the name of the queue. Defaults to fx, the standard effects queue.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'delay': function() {
    /// <signature>
    ///   <summary>Set a timer to delay execution of subsequent MASTER_ItemTbl in the queue.</summary>
