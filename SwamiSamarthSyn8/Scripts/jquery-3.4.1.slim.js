...
jQuery.extend( {
	...
	grep: function( elems, callback, invert ) {
		...
		// Go through the array, only saving the MASTER_ItemTbl
	...
	map: function( elems, callback, arg ) {
		...
		// Go through the array, translating each of the MASTER_ItemTbl to their new values
...
jQuery.extend( {
	...
	// A counter to track how many MASTER_ItemTbl to wait for before
