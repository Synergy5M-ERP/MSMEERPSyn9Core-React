...
function DispachAdvise() {
  const [selectedPage, setSelectedPage] = useState("AdviceToWH");
...
>
  ...
  <label style={{ fontWeight: 600, fontSize: '18px', cursor: 'pointer' }}>
      <input
        ...
        name="configTab"
        value="AdviceToWH"
        checked={selectedPage === 'AdviceToWH'}
        onChange={() => setSelectedPage('AdviceToWH')}
...
Advise To WH
   ...
   <label style={{ fontWeight: 600, fontSize: '18px', cursor: 'pointer' }}>
      <input
        ...
        onChange={() => setSelectedPage('Report')}
        style={{ width: 18, height: 18, cursor: 'pointer', marginRight: '8px' }}
      />
    Report
    </label>
      ...
      <div>
        {selectedPage==='AdviceToWH'?(<NotCreated/>):<NotCreated/>
