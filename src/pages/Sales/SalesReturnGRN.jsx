...
>
  ...
  SO Wise
   ...
   <label style={{ fontWeight: 600, fontSize: '18px', cursor: 'pointer' }}>
      <input
        type="radio"
        name="configTab"
        value="MultipleSOWise"
        checked={selectedPage === 'MultipleSOWise'}
        onChange={() => setSelectedPage('MultipleSOWise')}
        style={{ width: 18, height: 18, cursor: 'pointer', marginRight: '8px' }}
      />
    Multiple SO Wise
    </label>
 ...
 <label style={{ fontWeight: 600, fontSize: '18px', cursor: 'pointer' }}>
      <input
        ...
        name="configTab"
        value="GRNDownload"
        checked={selectedPage === 'GRNDownload'}
        onChange={() => setSelectedPage('GRNDownload')}
        style={{ width: 18, height: 18, cursor: 'pointer', marginRight: '8px' }}
      />
    GRN Download
    </label>
      ...
      <div>
        {selectedPage==='SOWise'?(<NotCreated/>):selectedPage==='MultipleSOWise'?(<NotCreated/>):<NotCreated/>
