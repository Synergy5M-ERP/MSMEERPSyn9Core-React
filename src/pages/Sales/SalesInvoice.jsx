...
function SalesInvoice() {
  const [selectedPage, setSelectedPage] = useState("createSalesInvoice"); // createSalesInvoice | AmendSalesInvoice | report
  ...
  const renderContent = () => {
    if (selectedPage === "createSalesInvoice") return <NotCreated />;

    // if (selectedPage === "AmendSalesInvoice") return <NotCreated />;
  ...
  return (
    <div style={{ minHeight: "80vh" }}>
      <h2 style={{ textAlign: "left", color: "#0066cc", marginBottom: 0 }}>Sales Invoice</h2>
        ...
        <div style={{ display: "flex", gap: "30px" }}>
          <label style={{ fontWeight: 600, fontSize: "18px", cursor: "pointer" }}>
            <input
              ...
              checked={selectedPage === "createSalesInvoice"}
              onChange={() => setSelectedPage("createSalesInvoice")}
          ...
          {/* <label style={{ fontWeight: 600, fontSize: "18px", cursor: "pointer" }}>
            <input
              type="radio"
              name="configTab"
              value="AmendSalesInvoice"
              checked={selectedPage === "AmendSalesInvoice"}
              onChange={() => setSelectedPage("AmendSalesInvoice")}
              style={{ width: 18, height: 18, cursor: "pointer", marginRight: "8px" }}
            />
            Amend Sales Invoice
          </label> */}
