...
label:'Bill Of Material',icon:<RiBillFill/>,key:'BillOFMaterial'
    ...
    // Close flyout submenu if MasterSidebar collapses
    ...
    return (
        ...
        >
            <button
                ...
                aria-label={collapsed ? 'Expand MasterSidebar' : 'Collapse MasterSidebar'}
            >
                {/* Account And Finance */}
                {collapsed ? '▶' : '◀'}
            </button>
                ...
                {menuItems.map((item) => {
                    ...
                    return (
                        <li key={item.key} style={{ position: 'relative' }}>
                            ...
                            {/* Submenu: Expanded & MasterSidebar expanded */}
