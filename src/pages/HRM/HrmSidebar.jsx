...
const HrmSidebar = ({ selected, onSelect }) => {
...

{
    ...
    // Close flyout submenu if HrmSidebar collapses
    ...
    return (
        ...
        >
            <button
                ...
                aria-label={collapsed ? 'Expand HrmSidebar' : 'Collapse HrmSidebar'}
            >
                {/* Account And Finance */}
                {collapsed ? '▶' : '◀'}
            </button>
                ...
                {menuItems.map((item) => {
                    ...
                    return (
                        <li key={item.key} style={{ position: 'relative' }}>
                            ...
                            {/* Submenu: Expanded & HrmSidebar expanded */}
